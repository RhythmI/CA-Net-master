...
from networks.Trans12VNet5 import VNet
from networks.discriminator_SEAttention import FC3DDiscriminator
...
parser.add_argument('--exp', type=str,  default='CA-Net', help='model_name')
